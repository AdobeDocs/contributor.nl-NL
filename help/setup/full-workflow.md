...
description: Leer hoe u bijdragen kunt leveren aan de documentatie van de Adobe op Experience League.
...
Als u met de concepten Git en GitHub zoals een bewaarplaats of een tak onbekend bent, gelieve eerst te herzien [ Git en de fundamentele waarden van GitHub ](git-fundamentals.md).
